...
if( $some_boolean_condition)
  ...
  //One liner
if( $some_boolean_condition) echo 'This is a true condition' . PHP_EOL;else  echo 'This is a false condition' . PHP_EOL;
...
$result = "Passed";
if($result === "Passed"){
   echo "Student has Passed examp";
}else {
   echo "Student has NOT passed examp";
}
